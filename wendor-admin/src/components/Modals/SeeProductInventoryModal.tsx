        ...
        <ModalProvider isOpen={isOpen} setIsOpen={setIsOpen} action={handleAddProducts} title="Product Inventory">
            {prodData && prodData.length > 0 ? <div className="w-full px-6 h-full flex flex-col poppins">
                <div>
                    ...
                    <h4 className="text-lg text-gray-600 whitespace-nowrap">{prodData[0].companyName}</h4>
                </div>
                <div className="w-full flex gap-10 h-full">
                    <div className="flex w-[20%] flex-col gap-3 pt-5">
                        <h4 className="text-xl whitespace-nowrap">Quantity: {totalQuantity} Pcs</h4>
                        <h4 className="text-xl whitespace-nowrap">Price: ₹{prodData[0].productPrice}</h4>
                        <h4 className="text-xl whitespace-nowrap">Total Batches: {prodData.length}</h4>
                    </div>
                    ...
                    <div className="h-full w-full pt-5 flex flex-col gap-5">
                        ...
                        <div className="border-2 max-h-[50vh] rounded-lg overflow-x-hidden overflow-y-auto">
                            <table className="w-full">
                                <thead className="border-b-1 sticky top-0 bg-gray-700 text-white">
                                    <tr className="">
