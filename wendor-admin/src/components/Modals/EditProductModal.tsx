        ...
        <ModalProvider isOpen={isOpen} setIsOpen={setIsOpen} loading={loading} full={false} action={handleEditProduct} title="Edit Product">
            <div className="w-2/3 mx-auto flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                    ...
                    <Input className="!border-zinc-200 border !rounded-md" name="barcodeNo" onChange={handleOnChange} value={editingValue?.barcodeNo} placeholder="Enter product name" />
                    <Input className="!border-zinc-200 border !rounded-md" type="number" name="price" onChange={handleOnChange} value={editingValue?.price} placeholder="Enter product name" />
